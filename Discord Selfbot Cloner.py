...
async def on_connect():
    ...
    for channel in guild.text_channels:
        ...
        await new_txt_chan.create_text_channel(name=channel.name, topic=channel.topic, position=channel.position, slowmode_delay=channel.slowmode_delay, nsfw=channel.is_nsfw(), overwrites=channel.overwrites)
    ...
    for channel in guild.voice_channels:
        ...
        await new_voc_chan.create_voice_channel(name=channel.name, position=channel.position, user_limit=channel.user_limit, overwrites=channel.overwrites)
    await client.close()
